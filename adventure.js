...
Do you follow it, or continue on your path?`)
        ...
        if(secondAnswer.toLowerCase() == 'follow'){
            ...
            if(thirdAnswer.toLowerCase() == 'ladder'){
                alert(`After ascending a few feet up the ladder, one of its rungs snaps, 
                ...
                alert(`After ascending the staircase, you discover a shiny blue stone, 
...
lead you away from the dragon altogether. Which path do you take?`)
        ...
        if(secondAnswer.toLowerCase() == 'past the dragon'){
            ...
            if(thirdAnswer.toLowerCase() == 'draw it'){
                alert(`You draw the flower, capturing only a fraction of its beauty with your quill. 
                ...
                alert(`You pick the flower and bring it home, and all marvel at its brilliance. 
